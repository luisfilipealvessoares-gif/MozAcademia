...
const quizData = {
  title: 'AVALIAÇÃO FINAL - MÓDULO I',
  instructions: 'Leia atentamente cada pergunta e selecione a única opção correta. Você precisa de 3 de 5 acertos para passar.',
  questions: [
    {
      question: '1. Qual das opções representa corretamente as "rochas geradoras"?',
      options: [
        'A) Rochas arenosas',
        'B) Rochas sedimentares ricas em matéria orgânica',
        'C) Rochas cristalinas',
        'D) Rochas metamórficas antigas',
      ],
      correctAnswerIndex: 1,
    },
    {
      question: '2. Que tipo de infraestrutura é típica do segmento Midstream?',
      options: [
        'A) Plataformas de perfuração',
        'B) Refinarias',
        'C) Oleodutos, gasodutos e terminais',
        'D) Postos de abastecimento',
      ],
      correctAnswerIndex: 2,
    },
    {
      question: '3. Quais são os desafios e riscos do sector de P&G em Moçambique?',
      options: [
        'A) Compra de refinarias',
        'B) Construção de ductos de exportação',
        'C) Instalação de plataformas e sistemas de produção',
        'D) Estudos de impacto ambiental',
      ],
      correctAnswerIndex: 2,
    },
    {
      question: '4. Qual é a capacidade anual de produção do Coral Sul FLNG?',
      options: [
        'A) 1 milhão de toneladas de GNL',
        'B) 3,4 milhões de toneladas de GNL',
        'C) 6,2 milhões de toneladas de GNL',
        'D) 10 milhões de toneladas de GNL',
      ],
      correctAnswerIndex: 1,
    },
    {
      question: '5. Que medida ajuda a reduzir o erro humano?',
      options: [
        'A) Emissão de relatórios de incidentes',
        'B) Treinamento contínuo e cultura de segurança',
        'C) Redução do número de operadores',
        'D) Emissão de procedimentos escritos',
      ],
      correctAnswerIndex: 1,
    },
  ],
...
interface Module1FinalQuizProps {
    onComplete: () => void;
}

const Module1FinalQuiz: React.FC<Module1FinalQuizProps> = ({ onComplete }) => {
...
export default Module1FinalQuiz;
