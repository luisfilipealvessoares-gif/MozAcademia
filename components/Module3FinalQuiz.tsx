...
const quizData = {
  ...
  questions: [
    ...
    {
      question: '2. Qual destas não é uma vantagem económica do gás?',
      options: [
        'A) Aumento do PIB',
        'B) Criação de postos de empregos',
        'C) Aumento das exportações de GNL',
        'D) Parcerias entre PMEs',
      ],
    ...
    },
    {
      ...
      options: [
        'A) Corrupção, segurança, ambiente',
        'B) Geração eléctrica e produção de fertilizantes',
        'C) Analfabetismo e falta de emprego',
        'D) Redução de divisas',
      ],
      correctAnswerIndex: 0,
    },
    {
      question: '4. Quais dos seguintes bens e serviços são altamente especializados?',
      options: [
        'A) Desalfandegamento, serviços jurídicos, logística portuária',
        'B) Material de escritório, serviços informáticos, alimentação eléctrica',
        'C) Restauração, hotelaria, serviços de urgência',
        'D) Equipamentos subaquáticos, serviços de perfuração, pesquisas sísmicas',
      ],
      correctAnswerIndex: 3,
    },
    {
      question: '5. Qual é o projecto em planeamento na área 4?',
      options: [
        'A) Coral Sul FLNG',
        'B) Rovuma LNG',
        'C) Central Térmica de Temane',
        'D) Baragem de Mphanda Nkuwa',
      ],
...
interface Module3FinalQuizProps {
    onComplete: () => void;
}

const Module3FinalQuiz: React.FC<Module3FinalQuizProps> = ({ onComplete }) => {
...
export default Module3FinalQuiz;
