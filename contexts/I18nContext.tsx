...
const translations = {
  pt: {
    ...
    'home.whyUs.title': 'Por que escolher a MozUp Academy?',
    ...
    // Auth Page
    'auth.loginTitle': 'Inicie a sessão',
    ...
    'auth.confirmPasswordPlaceholder': 'Confirmar a palavra-passe',
    ...
    'auth.adminCredentialsError': 'Credenciais de administrador. Por favor, use o portal de Acesso do Formador.',
    ...
    'auth.emailConfirmation.resendButton': 'Reenviar o e-mail de confirmação',
    'auth.emailConfirmation.resending': 'A reenviar...',
    'auth.emailConfirmation.resendSuccess': 'E-mail de confirmação reenviado com sucesso!',
    ...
    // About Page
    'about.title': 'Sobre a MozUp Academy',
    'about.mission': 'A Nossa Missão',
    'about.subtitle': 'Capacitação Digital para o Crescimento Empresarial',
    'about.p1': 'A MozUp Academy é a plataforma de e-learning do MozUp, concebida para reforçar a competitividade das empresas moçambicanas através da transferência estruturada de conhecimento especializado.',
    'about.p2': 'Enquanto extensão digital do centro de excelência MozUp, a Academia disponibiliza programas de formação desenvolvidos por especialistas da indústria, com enfoque em sectores estratégicos para o desenvolvimento económico nacional, incluindo Gás Natural Liquefeito (GNL)',
    'about.p3': 'O nosso compromisso é dotar profissionais e empresas das competências técnicas e estratégicas necessárias para competir de forma sustentável em mercados locais e internacionais.',

    // Support Page (User)
    'user.support.title': 'Suporte e Contactos',
    'user.support.subtitle': 'Estamos à sua disposição para fornecer suporte. Encontre respostas ou entre em contacto connosco.',
    'user.support.contacts.title': 'Informações de Contacto',
    'user.support.contacts.email.title': 'E-mail',
    ...
    'user.support.faq.q1': 'Como posso alterar a minha palavra-passe?',
    ...
    'user.support.faq.q4': 'Não consigo visualizar os vídeos. O que devo fazer?',
    ...
    'terms.p1': 'A MozUp Academy é a plataforma oficial de e-learning do MozUp, centro de excelência dedicado a fortalecer a competitividade das empresas moçambicanas por meio da capacitação profissional e transferência de conhecimentos.',
    ...
    'terms.h1': '1. Objecto',
    'terms.p1_1': 'Este Termo regula o acesso e utilização da plataforma MozUp Academy, que disponibiliza cursos digitais pré-gravados e conteúdos educacionais destinados exclusivamente à formação e capacitação profissional.',
    ...
    'terms.p3_1': 'A MozUp Academy reserva-se o direito de: Actualizar, modificar ou remover conteúdos a qualquer momento; Suspender ou cancelar contas que violem este Termo; Monitorizar a utilização da plataforma para fins de segurança, qualidade e conformidade legal.',
    'terms.h4': '4. Propriedade Intelectual',
    'terms.p4_1': 'Todos os cursos, vídeos, textos, materiais, metodologias, marcas e sistemas são propriedade exclusiva do MozUp / MozUp Academy. É expressamente proibido: Copiar, gravar, descarregar, partilhar ou redistribuir conteúdos; Revender ou utilizar os cursos para formação externa; Disponibilizar acessos a terceiros não autorizados. Qualquer violação constitui infração legal e poderá resultar em sanções civis e criminais.',
    ...
    'terms.p6_1': 'Em caso de utilização indevida, a MozUp Academy poderá: Bloquear imediatamente o acesso; Cancelar planos activos sem reembolso; Tomar medidas legais cabíveis para reparação de danos.',
    'terms.h7': '7. Limitação de Responsabilidade',
    'terms.p7_1': 'A MozUp Academy: Não garante resultados profissionais, financeiros ou comerciais; Não se responsabiliza por decisões tomadas com base nos conteúdos; Oferece os cursos como ferramenta de capacitação, não como consultoria personalizada.',
    'terms.h8': '8. Protecção de Dados',
    'terms.p8_1': 'Os dados fornecidos serão utilizados apenas para: Gestão de contas; Comunicação institucional; Melhoria da experiência da plataforma. Nunca serão vendidos ou partilhados sem consentimento legal.',
    'terms.h9': '9. Rescisão',
    'terms.p9_1': 'O utilizador pode encerrar a utilização da plataforma a qualquer momento. A MozUp Academy pode rescindir o acesso em caso de violação deste Termo.',
    'terms.h10': '10. Legislação Aplicável',
    'terms.p10_1': 'Este Termo rege-se pelas leis da República de Moçambique, sendo competente o foro local para resolução de quaisquer litígios.',
    'terms.final': 'Ao utilizar a MozUp Academy, o utilizador declara concordar integralmente com este Termo.',
    'terms.acceptButton': 'Aceito',

    // Privacy Policy Page
    'privacy.title': 'Política de Privacidade',
    'privacy.lastUpdated': 'Última atualização: 25 de Julho de 2024',
    'privacy.intro': 'A sua privacidade é importante para nós. Esta política de privacidade explica que dados pessoais a MozUp Academy recolhe, como os processamos e para que fins.',
    'privacy.section1.title': 'Dados que Coletamos',
    'privacy.section1.p1': 'Recolhemos dados para operar de forma eficaz e fornecer-lhe as melhores experiências com os nossos serviços. Você fornece alguns desses dados diretamente, como quando cria uma conta. Recolhemos informações sobre:',
    'privacy.section1.list.item1': 'Informações de Registo: Nome, e-mail, palavra-passe.',
    'privacy.section1.list.item2': 'Informações de Perfil: Empresa, telefone, sexo, idade e outras informações profissionais que nos fornece.',
    'privacy.section1.list.item3': 'Progresso do Curso: Dados sobre os cursos em que se inscreve, módulos concluídos e resultados de quizzes.',
    'privacy.section1.list.item4': 'Dados de Utilização: Informações sobre como interage com a nossa plataforma.',
    'privacy.section2.title': 'Como Usamos os Seus Dados',
    'privacy.section2.p1': 'Usamos os dados que recolhemos para:',
    'privacy.section2.list.item1': 'Fornecer e gerir os nossos serviços, incluindo o seu acesso aos cursos.',
    'privacy.section2.list.item2': 'Personalizar a sua experiência de aprendizagem.',
    'privacy.section2.list.item3': 'Comunicar consigo sobre a sua conta, cursos e atualizações da plataforma.',
    'privacy.section2.list.item4': 'Melhorar e desenvolver os nossos produtos.',
    'privacy.section3.title': 'Partilha de Dados',
    'privacy.section3.p1': 'Não partilhamos os seus dados pessoais com terceiros, exceto conforme necessário para fornecer os nossos serviços (por exemplo, com os nossos provedores de infraestrutura) ou conforme exigido por lei.',
    'privacy.section4.title': 'Cookies e Tecnologias Semelhantes',
    'privacy.section4.p1': 'Usamos cookies e tecnologias semelhantes para operar o nosso site, ajudar a analisar o seu desempenho e para fins de autenticação.',
    'privacy.section5.title': 'Segurança dos Dados',
    'privacy.section5.p1': 'Comprometemo-nos a proteger a segurança dos seus dados pessoais. Usamos uma variedade de tecnologias e procedimentos de segurança para ajudar a proteger os seus dados contra acesso, uso ou divulgação não autorizados.',
    'privacy.section6.title': 'Os Seus Direitos',
    'privacy.section6.p1': 'Você tem o direito de:',
    'privacy.section6.list.item1': 'Aceder e rever os dados que temos sobre si.',
    'privacy.section6.list.item2': 'Solicitar a correção de dados imprecisos.',
    'privacy.section6.list.item3': 'Solicitar a exclusão dos seus dados, sujeito a certas condições legais.',
    'privacy.section7.title': 'Alterações a Esta Política',
  ...
  en: {
    ...
    'footer.adminLogin': 'Trainer Access',
    'footer.maputo': 'Maputo',
    'footer.pemba': 'Pemba',
    ...
    'home.whyUs.title': 'Why choose MozUp Academy?',
    ...
    'auth.adminCredentialsError': 'Administrator credentials. Please use the Trainer Access portal.',
    ...
    // About Page
    'about.title': 'About MozUp Academy',
    'about.mission': 'Our Mission',
    'about.subtitle': 'Digital Empowerment for Business Growth',
    'about.p1': 'MozUp Academy is MozUp\'s e-learning platform, designed to strengthen the competitiveness of Mozambican companies through the structured transfer of specialized knowledge.',
    'about.p2': 'As a digital extension of the MozUp center of excellence, the Academy provides training programs developed by industry experts, focusing on strategic sectors for national economic development, including Liquefied Natural Gas (LNG).',
    'about.p3': 'Our commitment is to equip professionals and companies with the technical and strategic skills necessary to compete sustainably in local and international markets.',
    ...
    'terms.p1': 'MozUp Academy is the official e-learning platform of MozUp, a center of excellence dedicated to strengthening the competitiveness of Mozambican companies through professional training and knowledge transfer.',
    ...
    'terms.h1': '1. Object',
    'terms.p1_1': 'This Agreement regulates the access and use of the MozUp Academy platform, which provides pre-recorded digital courses and educational content intended exclusively for professional training and capacitation.',
    ...
    'terms.p3_1': 'MozUp Academy reserves the right to: Update, modify, or remove content at any time; Suspend or cancel accounts that violate this Agreement; Monitor platform usage for security, quality, and legal compliance purposes.',
    'terms.h4': '4. Intellectual Property',
    'terms.p4_1': 'All courses, videos, texts, materials, methodologies, brands, and systems are the exclusive property of MozUp / MozUp Academy. It is expressly forbidden to: Copy, record, download, share, or redistribute content; Resell or use the courses for external training; Provide access to unauthorized third parties. Any violation constitutes a legal infraction and may result in civil and criminal penalties.',
    ...
    'terms.p6_1': 'In case of misuse, MozUp Academy may: Immediately block access; Cancel active plans without a refund; Take appropriate legal action to seek compensation for damages.',
    'terms.h7': '7. Limitation of Liability',
    'terms.p7_1': 'MozUp Academy: Does not guarantee professional, financial, or commercial results; Is not responsible for decisions made based on the content; Offers the courses as a training tool, not as personalized consulting.',
    'terms.h8': '8. Data Protection',
    'terms.p8_1': 'The data provided will only be used for: Account management; Institutional communication; Improving the platform experience. It will never be sold or shared without legal consent.',
    'terms.h9': '9. Termination',
    'terms.p9_1': 'The user may terminate their use of the platform at any time. MozUp Academy may terminate access in case of violation of this Agreement.',
    'terms.h10': '10. Applicable Law',
    'terms.p10_1': 'This Agreement is governed by the laws of the Republic of Mozambique, with the local jurisdiction being competent to resolve any disputes.',
    'terms.final': 'By using MozUp Academy, the user declares to fully agree with this Agreement.',
    'terms.acceptButton': 'I Accept',

    // Privacy Policy Page
    'privacy.title': 'Privacy Policy',
    'privacy.lastUpdated': 'Last updated: July 25, 2024',
    'privacy.intro': 'Your privacy is important to us. This privacy policy explains what personal data MozUp Academy collects, how we process it, and for what purposes.',
    'privacy.section1.title': 'Data We Collect',
    'privacy.section1.p1': 'We collect data to operate effectively and provide you with the best experiences with our services. You provide some of this data directly, such as when you create an account. We collect information about:',
    'privacy.section1.list.item1': 'Registration Information: Name, email, password.',
    'privacy.section1.list.item2': 'Profile Information: Company, phone number, gender, age, and other professional information you provide.',
    'privacy.section1.list.item3': 'Course Progress: Data about the courses you enroll in, completed modules, and quiz results.',
    'privacy.section1.list.item4': 'Usage Data: Information about how you interact with our platform.',
    'privacy.section2.title': 'How We Use Your Data',
    'privacy.section2.p1': 'We use the data we collect to:',
    'privacy.section2.list.item1': 'Provide and manage our services, including your access to courses.',
    'privacy.section2.list.item2': 'Personalize your learning experience.',
    'privacy.section2.list.item3': 'Communicate with you about your account, courses, and platform updates.',
    'privacy.section2.list.item4': 'Improve and develop our products.',
    'privacy.section3.title': 'Data Sharing',
    'privacy.section3.p1': 'We do not share your personal data with third parties, except as necessary to provide our services (e.g., with our infrastructure providers) or as required by law.',
    'privacy.section4.title': 'Cookies and Similar Technologies',
    'privacy.section4.p1': 'We use cookies and similar technologies to operate our website, help analyze its performance, and for authentication purposes.',
    'privacy.section5.title': 'Data Security',
    'privacy.section5.p1': 'We are committed to protecting the security of your personal data. We use a variety of security technologies and procedures to help protect your data from unauthorized access, use, or disclosure.',
    'privacy.section6.title': 'Your Rights',
    'privacy.section6.p1': 'You have the right to:',
    'privacy.section6.list.item1': 'Access and review the data we hold about you.',
    'privacy.section6.list.item2': 'Request the correction of inaccurate data.',
    'privacy.section6.list.item3': 'Request the deletion of your data, subject to certain legal conditions.',
