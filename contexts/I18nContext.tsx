...
const translations = {
  pt: {
    ...
    'terms.p8_1': 'A MozUp Academy: Não garante resultados profissionais, financeiros ou comerciais; Não se responsabiliza por decisões tomadas com base nos conteúdos; Oferece os cursos como ferramenta de capacitação, não como consultoria personalizada.',
    ...
    'terms.p10_1': 'O utilizador pode encerrar a utilização da plataforma a qualquer momento. A MozUp Academy pode rescindir o acesso em caso de violação deste Termo.',
  ...
  en: {
    ...
    'terms.p8_1': 'MozUp Academy: Does not guarantee professional, financial, or commercial results; Is not responsible for decisions made based on the content; Offers the courses as a training tool, not as personalized consulting.',
    ...
    'terms.p10_1': 'The user may terminate their use of the platform at any time. MozUp Academy may terminate access in case of violation of this Agreement.',
